...
const features = [
  ...
  },
  {
    ...
    steps: [
      ...
      "Priority Score = prioridade de aporte, com os pesos que você define para qualidade, déficit, excesso, prioridade manual, momento e oportunidade de preço",
      "ELEGIBILIDADE vem antes do score: critério eliminatório, limite de concentração, preço máximo de compra e momento zero DESCARTAM o ativo — o sistema mostra o motivo de cada descarte",
      "Preço máximo de compra por ativo (na meta): acima dele o ativo sai do aporte, por melhor que seja o Quality Score",
      ...
      "Próximos Aportes: o dinheiro é rateado por CLASSE → SUBCLASSE → SETOR → ativo, com teto no déficit do nível",
      "Classe no alvo (ou acima) não recebe aporte; dentro da classe em déficit, o ticker entra pelo Priority Score",
